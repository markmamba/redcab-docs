---
title: "131 — Migrate geography schema to catalog_countries and catalog_geographies"
...
Flat `catalog_districts` / `catalog_areas` cannot express the ADR-016 administrative tree. Epic #130 requires schema migration before seed and domain code. Issue #131 implements spec [geography-administrative-tree.md](./geography-administrative-tree.md) migration sequence steps 2–7 only.
...
| ID | Document | Why |
| --- | --- | --- |
| Parent spec | [geography-administrative-tree.md](./geography-administrative-tree.md) | Authoritative §3.4 columns, indexes, CHECK constraints, migration steps 2–7 |
| ADR-016 | [architecture/decisions/adr-016-geography-administrative-tree.md](../architecture/decisions/adr-016-geography-administrative-tree.md) | Tree shape, C1 discovery roots |
...
| Geography review | [roadmap/notes/geography-data-model-review.md](../roadmap/notes/geography-data-model-review.md) | §4 backfill mapping when legacy rows exist |
| INV-8, INV-11 | [business-rules/invariants.md](../business-rules/invariants.md) | Listing location; archive never delete |
| Backend conventions | [engineering/backend-conventions.md](../engineering/backend-conventions.md) | `timestamptz`, string enums, explicit FKs |
...
- [ ] PR triple-links: `red-cab-api#131`, `red-cab-api#130`, `Spec: docs/specs/131-migrate-geography-schema.md`
