---
title: "132 — Seed Japan geography from official administrative codes"
...
Evidence: `redcab-docs/docs/specs/geography-administrative-tree.md` Seed contract §; `redcab-docs/docs/roadmap/notes/geography-data-model-review.md` §4 step 8; issue #132.

## Governing docs

| ID | Document | Why |
| --- | --- | --- |
| Parent spec | [geography-administrative-tree.md](./geography-administrative-tree.md) | Seed contract, derivation rules, row counts |
| Prerequisite | [131-migrate-geography-schema.md](./131-migrate-geography-schema.md) | Schema must exist; JP country row seeded |
| FR-CAT-001 | [requirements/functional-requirements/cat.md](../requirements/functional-requirements/cat.md) | Official-code idempotent upsert |
| ADR-013 | [architecture/decisions/adr-013-geography-reference-data.md](../architecture/decisions/adr-013-geography-reference-data.md) | Vendored offline sources |
| ADR-014 | [architecture/decisions/adr-014-service-timezone-model.md](../architecture/decisions/adr-014-service-timezone-model.md) | `timezone` on every node |
| ADR-016 | [architecture/decisions/adr-016-geography-administrative-tree.md](../architecture/decisions/adr-016-geography-administrative-tree.md) | C1 discovery roots, tree levels |
| geography.md | [architecture/geography.md](../architecture/geography.md) | Seed pipeline procedure, slug rules |
| domain-to-code-mapping | [engineering/domain-to-code-mapping.md](../engineering/domain-to-code-mapping.md) | `catalog/geography/` module placement |
