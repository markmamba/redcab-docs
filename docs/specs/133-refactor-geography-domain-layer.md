---
title: "133 — Refactor geography domain layer and listing attachment"
...
context: CAT
depends_on:
  - "docs/specs/131-migrate-geography-schema.md (status: approved)"
  - "docs/specs/132-seed-japan-geography.md (status: approved)"
...
| ID | Document | Why |
| --- | --- | --- |
| Parent spec | [geography-administrative-tree.md](./geography-administrative-tree.md) | Epic step 9 scope; `discoverable`, provider write, directory naming |
| Prerequisite | [131-migrate-geography-schema.md](./131-migrate-geography-schema.md) | Schema already migrated |
| Prerequisite | [132-seed-japan-geography.md](./132-seed-japan-geography.md) | Seed task exists; anonymous AR stubs deferred here |
| FR-CAT-033 | [requirements/functional-requirements/cat.md](../requirements/functional-requirements/cat.md) | Listable-leaf listing attach |
| INV-8 | [business-rules/invariants.md](../business-rules/invariants.md) | Subtree discoverability |
...
| ADR-016 | [architecture/decisions/adr-016-geography-administrative-tree.md](../architecture/decisions/adr-016-geography-administrative-tree.md) | Tree shape, path, discovery roles |
| domain-to-code-mapping | [engineering/domain-to-code-mapping.md](../engineering/domain-to-code-mapping.md) | `geography.rb` replaces flat models; `districts/` / `areas/` API surface unchanged |
| Backend conventions | [engineering/backend-conventions.md](../engineering/backend-conventions.md) | No model validations; ActiveModel validators |
...
- [ ] PR triple-links: `red-cab-api#133`, `red-cab-api#130`, `Spec: docs/specs/133-refactor-geography-domain-layer.md`
