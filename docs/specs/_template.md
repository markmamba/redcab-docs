...
| ADR-??? | [architecture/decisions/](../architecture/decisions/) | Architecture constraint |
| INV-? | [business-rules/invariants.md](../business-rules/invariants.md) | Invariant |
| AMB-??? | [ambiguities/open-questions.md](../ambiguities/open-questions.md) | Open decision (if any) |
