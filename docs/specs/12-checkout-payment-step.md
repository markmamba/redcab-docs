---
title: "12 — Checkout payment step from payment_handoff descriptor"
...
| ID | Document | Why |
| --- | --- | --- |
| FR-PAY-015 | [requirements/functional-requirements/pay.md](../requirements/functional-requirements/pay.md) | Money state from verified provider events |
| FIN-11, FIN-13 | [architecture/payments-architecture.md](../architecture/payments-architecture.md) | Return redirect is presentation hint; poll API for confirmation |
| ADR-015 C6 | [architecture/decisions/adr-015-payment-custody-and-control-separation.md](../architecture/decisions/adr-015-payment-custody-and-control-separation.md) | Provider-agnostic handoff branching |
| INV-1 | [business-rules/invariants.md](../business-rules/invariants.md) | No client-authored price |
| frontend-conventions §7 | [engineering/frontend-conventions.md](../engineering/frontend-conventions.md) | Payment step rules |
| Spec #71 | [specs/71-payment-attempt-checkout.md](./71-payment-attempt-checkout.md) | Payment attempt contract |
...
Per [spec 71](./71-payment-attempt-checkout.md). Web sends:
...
| **Response 200** | `{ "uuid", "status": "pending"|"completed"|"expired", "booking_id": null\|uuid, "expires_at" }` |
