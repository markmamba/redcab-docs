---
title: "13 — Admin commission rate setting UI"
...
| ID | Document | Why |
| --- | --- | --- |
| FR-PAY-003 | [requirements/functional-requirements/pay.md](../requirements/functional-requirements/pay.md) | Rate changes apply only to subsequent bookings |
| FR-PAY-010 | [requirements/functional-requirements/pay.md](../requirements/functional-requirements/pay.md) | Admin can set platform-wide commission rate |
| PAY-2 | [business-rules/invariants.md](../business-rules/invariants.md) | Historical bookings retain commission snapshot |
| INV-1 | [business-rules/invariants.md](../business-rules/invariants.md) | Booking snapshots immutable after create |
| Phase 1 | [roadmap/phase-1-mvp.md](../roadmap/phase-1-mvp.md) | Admin commission rate setting UI |
| OPR-11 | `red-cab-api/docs/db/payments.dbml` | `effective_from` evaluated in `Asia/Tokyo` |
| Web conventions | [engineering/frontend-conventions.md](../engineering/frontend-conventions.md) | Team portal patterns |
