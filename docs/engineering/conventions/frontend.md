...
| Functional behavior | [Functional Requirements](/docs/product/requirements/functional-requirements) |
...
See [Domain-to-Code Mapping](/docs/engineering/conventions/domain-to-code-mapping) for surface → route group mapping.
...
### SEO / public catalog routes

Public catalog routes (`/`, `/districts`, `/districts/:districtSlug`, listings funnel) follow the [web-56 route contract](/docs/engineering/specs/iam/web-56-tourist-access-and-route-contract):
...
- See [Geography](/docs/architecture/patterns/geography).
