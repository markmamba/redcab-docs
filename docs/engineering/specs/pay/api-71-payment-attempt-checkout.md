---
title: "Payment attempt and handoff at checkout"
sidebar_label: API · Payment attempt
...
| ID | Document | Why |
| --- | --- | --- |
| FR-BKG-005 | [/docs/product/requirements/functional-requirements/bkg.md](/docs/product/requirements/functional-requirements/bkg) | Failed payment yields no booking |
| FR-PAY-012 | [/docs/product/requirements/functional-requirements/pay.md](/docs/product/requirements/functional-requirements/pay) | Terms required before payment |
| FR-PAY-015 | [/docs/product/requirements/functional-requirements/pay.md](/docs/product/requirements/functional-requirements/pay) | Money state from verified provider events only |
| PAY-5, CON-5 | [Booking state machine](/docs/architecture/patterns/booking-state-machine) | Failure releases seats; idempotent restore |
| FIN-10 | [domain/domain-models.md](/docs/architecture/domain/domain-models) | Idempotent webhook redelivery |
| ADR-015 C6 | [architecture/decisions/adr-015-payment-custody-and-control-separation.md](/docs/architecture/decisions/adr-015-payment-custody-and-control-separation.md) | Adapter-only integration |
| INV-1 | [/docs/product/business-rules/invariants](/docs/product/business-rules/invariants) | No client-authored price |
| INV-12 | [/docs/product/business-rules/invariants](/docs/product/business-rules/invariants) | Verified merchant for payouts |
| DBML | `red-cab-api/docs/db/payments.dbml` | Charge retry / partial unique semantics |
| Spec #70 | [spec./api-70-provider-merchant-onboarding.md](./api-70-provider-merchant-onboarding.md) | Manager + handoff serializer pattern |
