---
title: "Provider merchant onboarding via payment adapter"
sidebar_label: API · Merchant onboarding
...
| ID | Document | Why |
| --- | --- | --- |
| FR-PAY-015 | [/docs/product/requirements/functional-requirements/pay.md](/docs/product/requirements/functional-requirements/pay) | Money state advances on verified provider events only |
| ADR-015 C6 | [architecture/decisions/adr-015-payment-custody-and-control-separation.md](/docs/architecture/decisions/adr-015-payment-custody-and-control-separation.md) | Adapter-only integration; no provider identity branching |
| INV-12 | [/docs/product/business-rules/invariants](/docs/product/business-rules/invariants) | Publish gate requires verified merchant account |
| INV-13 | [/docs/product/business-rules/invariants](/docs/product/business-rules/invariants) | No platform custody |
| PAY bounded context | [Payments context](/docs/architecture/contexts/payments) | `payout_capability` sync read contract |
| DBML | `red-cab-api/docs/db/payments.dbml` | Table semantics, re-onboarding, no `:not_started` status |
| Backend conventions | [Backend conventions](/docs/engineering/conventions/backend) | Request → Manager → Validator pattern |
