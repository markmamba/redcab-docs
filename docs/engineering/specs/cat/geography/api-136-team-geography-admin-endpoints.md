---
title: "Team geography admin endpoints"
sidebar_label: API · Geography admin
...
context: CAT
depends_on:
  - "docs/engineering/specs/cat/geography/api-135-near-me-areas-endpoint.md (status: approved)"
...
| ID | Document | Why |
| --- | --- | --- |
| Parent spec | [docs-13-geography-administrative-tree.md](./docs-13-geography-administrative-tree.md) | Team admin API contract, lifecycle FSM, serializer matrix |
| Prerequisite | [133-refactor-geography-domain-layer.md](./api-133-refactor-geography-domain-layer.md) | `Catalog::Geography`, `discoverable`, `TreeValidator` |
| Prerequisite | [134-marketplace-geography-slug-and-ancestors.md](./api-134-marketplace-geography-slug-and-ancestors.md) | Read-side archive 301 (admin writes successor) |
| FR-CAT-001/002/034 | [/docs/product/requirements/functional-requirements/cat.md](/docs/product/requirements/functional-requirements/cat) | Admin curation, cascade, archive successor |
| NFR-I18N-003 | [requirements/non-functional-requirements.md](/docs/product/requirements/non-functional-requirements) | EN/JA (and kana) labels |
| INV-8, INV-11, OPR-10 | [/docs/product/business-rules/invariants](/docs/product/business-rules/invariants) | Subtree discoverability; archive never delete; cascade |
| ADR-016 | [architecture/decisions/adr-016-geography-administrative-tree.md](/docs/architecture/decisions/adr-016-geography-administrative-tree.md) | Tree shape, path, successor |
| geography.md | [architecture/geography.md](/docs/architecture/patterns/geography) | Admin workflow, label conventions |
| domain-to-code-mapping | [Domain-to-code mapping](/docs/engineering/conventions/domain-to-code-mapping) | `geographies/team_*` surface |
| Backend conventions | [Backend conventions](/docs/engineering/conventions/backend) | Request → Manager → Validator; explicit routes |
...
- [ ] PR triple-links: `red-cab-api#136`, `red-cab-api#130`, `Spec: docs/engineering/specs/cat/geography/api-136-team-geography-admin-endpoints.md`
