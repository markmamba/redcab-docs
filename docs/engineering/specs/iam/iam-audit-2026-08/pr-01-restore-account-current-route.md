---
title: "Restore GET /identities/accounts/current"
sidebar_label: 1 · Account current route
sidebar_position: 2
...
- [x] Full `bin/rails test` — capture the baseline. Expect failures in `test/domains/identities/password_resets/confirm_manager_test.rb` and possibly `…/email_verifications/confirm_manager_test.rb`; those are [PR-02](/docs/engineering/specs/iam/iam-audit-2026-08/pr-02-iam-security-fixes), not this PR. Record which tests fail so PR-02 can prove it fixed exactly those.
