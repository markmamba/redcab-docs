---
title: "Remove deprecated IAM routes and rename serializers"
sidebar_label: 8 · Deprecations
sidebar_position: 9
...
**Depends on:** [PR-04](/docs/engineering/specs/iam/iam-audit-2026-08/pr-04-account-current-patch), [PR-06](/docs/engineering/specs/iam/iam-audit-2026-08/pr-06-session-surface-symmetry), and their web follow-ups.
...
`UpdateLanguagePreference{Request,Validator,Manager}` and `Identities::AccountsController#update_language_preference` were already removed in [PR-04](/docs/engineering/specs/iam/iam-audit-2026-08/pr-04-account-current-patch). PR-08 only removes the stale route line that still 404s.
...
Move the four `show` test cases from `test/controllers/team/identities/admins/sessions_controller_test.rb` to a new `test/controllers/team/identities/admins_controller_test.rb`, if [PR-06](/docs/engineering/specs/iam/iam-audit-2026-08/pr-06-session-surface-symmetry) has not already created it.
