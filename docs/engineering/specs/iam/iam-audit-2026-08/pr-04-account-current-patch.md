---
title: "Consolidate account updates on PATCH /identities/accounts/current"
sidebar_label: 4 · Account PATCH
sidebar_position: 5
...
- **Legacy route:** `PATCH /identities/accounts/language_preference` still appears in `identities_routes.rb` but has **no controller action** (404). [PR-08](/docs/engineering/specs/iam/iam-audit-2026-08/pr-08-deprecations) removes the route; web must call `/current`.

**Fixes:** IAM-10 (Medium).

**Depends on:** [PR-01](/docs/engineering/specs/iam/iam-audit-2026-08/pr-01-restore-account-current-route) — `GET …/current` must exist for `PATCH …/current` to sit beside it.
...
| Legacy route | Delegates to `#update` | **No delegator** — `UpdateLanguagePreference*` deleted; legacy path 404s until [PR-08](/docs/engineering/specs/iam/iam-audit-2026-08/pr-08-deprecations) removes the route line |
...
Migrate off `PATCH …/language_preference` before [PR-08](/docs/engineering/specs/iam/iam-audit-2026-08/pr-08-deprecations).

---

## 8. Deliberately out of scope

- **Password changes** — requires current password and session revocation ([PR-02](/docs/engineering/specs/iam/iam-audit-2026-08/pr-02-iam-security-fixes) `RevokeAllService`).
...
| [PR-08](/docs/engineering/specs/iam/iam-audit-2026-08/pr-08-deprecations) | Route line **removed** | Works |
