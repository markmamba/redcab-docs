...
- **Exit criteria are observable outcomes** — the condition that means a phase is done. They map to functional requirements where possible; see [../requirements/traceability-matrix.md](/docs/product/requirements/traceability-matrix).
...
- **Agent sessions** should pick one context slice per phase step, read that context's requirements + business rules, and implement against [../engineering/backend-conventions.md](/docs/engineering/conventions/backend) and [../engineering/frontend-conventions.md](/docs/engineering/conventions/frontend).
...
| --- | --- | --- | --- |
| **0** | [Foundation](/docs/product/planning/roadmap/phase-0-foundation) | Runnable repos, IAM + profiles, event bus | IAM, profiles, NOT stub, engineering scaffold |
| **1** | [MVP — B2C happy path](/docs/product/planning/roadmap/phase-1-mvp) | End-to-end tourist booking + payout | PRV, CAT (basic), BKG, PAY, NOT |
| **1b** | [Tourist UI — pre–Phase 2](/docs/product/planning/roadmap/tourist-ui-pre-phase-2) | Tourist marketplace UX, funnel, Phase 2 UI slots | red-cab-web (Tourist App) |
| **2** | [Marketplace depth](/docs/product/planning/roadmap/phase-2-marketplace-depth) | Reviews, pricing, search, refunds | REV, CAT (advanced), BKG, PRV automation |
| **3** | [Corporate + packages](/docs/product/planning/roadmap/phase-3-corporate-packages) | Quotations, invoices, bank transfer | COR, BKG manifests, PAY reconciliation |
| **v2** | [Post-baseline](/docs/product/planning/roadmap/v2-post-baseline) | Unscheduled backlog | Ambiguity register |
...
2. Read the target context in [../architecture/contexts](/docs/architecture/contexts) and [/docs/architecture/domain/domain-models](/docs/architecture/domain/domain-models).
...
5. Filter requirements in [../requirements/traceability-matrix.md](/docs/product/requirements/traceability-matrix) by context and phase.
6. Check [/docs/product/planning/open-questions](/docs/product/planning/open-questions) for Provisional requirements — use temp assumption or resolve first.
7. Implement using [../engineering/domain-to-code-mapping.md](/docs/engineering/conventions/domain-to-code-mapping) and backend/frontend conventions.
...
- [../architecture/contexts](/docs/architecture/contexts) — context map and integration contracts
- [../architecture/data-model.md](/docs/architecture/data-model) — conceptual entities and ownership (semantics)
- [../requirements/traceability-matrix.md](/docs/product/requirements/traceability-matrix) — PRD → requirements → contexts
- [/docs/product/planning/open-questions](/docs/product/planning/open-questions) — open decisions and temp assumptions
- [/docs/engineering](/docs/engineering) — implementation conventions
