...
| Prior phase | [Phase 0](/docs/product/planning/roadmap/phase-0-foundation) |
| Next phase | [Phase 2](/docs/product/planning/roadmap/phase-2-marketplace-depth) |
| Tourist UI (before Phase 2) | [Tourist UI — pre–Phase 2](/docs/product/planning/roadmap/tourist-ui-pre-phase-2) |
| Resolved decisions | [Open Questions](/docs/product/planning/open-questions) (Decision Log) |

---

| [← Phase 0](/docs/product/planning/roadmap/phase-0-foundation) | [Tourist UI →](/docs/product/planning/roadmap/tourist-ui-pre-phase-2) |
