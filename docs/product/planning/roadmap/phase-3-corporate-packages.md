...
| Prior phase | [Phase 2](/docs/product/planning/roadmap/phase-2-marketplace-depth) |
| Corporate context | [Corporate Quotation](/docs/architecture/contexts/corporate) |
| Open decisions | [Open Questions](/docs/product/planning/open-questions) |

---

| [← Phase 2](/docs/product/planning/roadmap/phase-2-marketplace-depth) | [v2 →](/docs/product/planning/roadmap/v2-post-baseline) |
