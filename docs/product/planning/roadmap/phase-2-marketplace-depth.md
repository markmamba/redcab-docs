...
| Prior phase | [Phase 1](/docs/product/planning/roadmap/phase-1-mvp) |
| Tourist UI (complete first) | [Tourist UI — pre–Phase 2](/docs/product/planning/roadmap/tourist-ui-pre-phase-2) |
| Next phase | [Phase 3](/docs/product/planning/roadmap/phase-3-corporate-packages) |
| Reviews context | [Reviews & Ratings](/docs/architecture/contexts/reviews) |

---

| [← Tourist UI](/docs/product/planning/roadmap/tourist-ui-pre-phase-2) | [Phase 3 →](/docs/product/planning/roadmap/phase-3-corporate-packages) |
...
> **Tourist UI gate:** Complete [Tourist UI — pre–Phase 2](/docs/product/planning/roadmap/tourist-ui-pre-phase-2) (Milestones A–D) before wiring Phase 2 feature UI on tourist surfaces — IA, shells, funnel pages, and placeholder slots should be in place first.
