...
| Next phase | [Phase 1 — MVP](/docs/product/planning/roadmap/phase-1-mvp) |
| Engineering | [Engineering](/docs/engineering) |
| Identity context | [Identity & Access](/docs/architecture/contexts/identity) |

---

| [← Roadmap overview](/docs/product/planning/roadmap) | [Phase 1 →](/docs/product/planning/roadmap/phase-1-mvp) |
...
- [x] `.ai/instructions.md`, `.cursor/rules/`, and skills per [/docs/engineering](/docs/engineering)
...
- [x] Error response format — `Errors::*` hierarchy per [../engineering/backend-conventions.md](/docs/engineering/conventions/backend)
