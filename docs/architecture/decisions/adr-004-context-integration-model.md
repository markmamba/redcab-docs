...
- **Anti-Corruption Layer (ACL)** — B2B → Booking, where B2B translates its quotation vocabulary into Booking's command language at the call boundary so evolving B2B concepts never leak into Booking.
