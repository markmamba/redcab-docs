...
- **No pricing drift.** Because the calculation is never duplicated across Booking, Payments, COR, or the client, there are no copies to fall out of step as pricing configuration evolves (`CR-2`).
