...
- **Legal and commercial integrity.** The terms captured at agreement are the terms that were offered and accepted, so bookings — including corporate orders and the formal documents around them — remain a faithful record of a binding commitment (`PAY-10`, `LC-11`).
