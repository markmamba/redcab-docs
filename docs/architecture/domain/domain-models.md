...
These are tracked in [/docs/product/planning/open-questions](/docs/product/planning/open-questions); the model is built to accommodate either resolution and never silently assumes one.
