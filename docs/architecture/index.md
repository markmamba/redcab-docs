...
2. [Bounded Contexts](/docs/architecture/bounded-contexts) — ownership boundaries
...
4. [API Design](/docs/architecture/api-design) and [Data Model](/docs/architecture/data-model)
5. [Tech Stack](/docs/architecture/tech-stack) and [ADRs](/docs/architecture/decisions)
