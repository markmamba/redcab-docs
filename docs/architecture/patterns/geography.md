...
| Public URL contract | [Session A decision record](/docs/architecture/decisions/adr-017-tourist-ui-public-url-architecture) |
| FRs | [CAT functional requirements](/docs/product/requirements/functional-requirements/cat) |
| Decision Log | [Open Questions](/docs/product/planning/open-questions) (`AMB-036`) |
