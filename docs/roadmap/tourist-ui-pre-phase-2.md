...
Cross-cutting **red-cab-web** plan for the Tourist App surfaces. Backend phasing stays in [Phase 1](/docs/roadmap/phase-1-mvp) and [Phase 2](/docs/roadmap/phase-2-marketplace-depth); this document defines **what the tourist UI should look like and how pages connect** before Phase 2 feature UI lands.

| Topic | Document |
| --- | --- |
| Roadmap overview | [Phasing Roadmap](/docs/roadmap) |
| Phase 1 (API + minimum pages) | [Phase 1 — MVP](/docs/roadmap/phase-1-mvp) |
| Phase 2 (reviews, search, refunds) | [Phase 2 — Marketplace depth](/docs/roadmap/phase-2-marketplace-depth) |
| Frontend conventions | [Frontend conventions](/docs/engineering/frontend-conventions) |
| Guest browsing (`AMB-022`) | [Open Questions](/docs/ambiguities/open-questions) |
| Discovery IA (`AMB-020`) | Decision Log — District → Area canonical |

---

| [← Phase 1](/docs/roadmap/phase-1-mvp) | [Phase 2 →](/docs/roadmap/phase-2-marketplace-depth) |
...
- [ ] Minimal design tokens documented (Bootstrap-first; overrides in `_variables.scss` per [frontend conventions](/docs/engineering/frontend-conventions))
...
Scaffold **named slots** on existing pages. Do not implement Phase 2 API clients until [Phase 2](/docs/roadmap/phase-2-marketplace-depth) specs are approved. Placeholders may be hidden, disabled, or labeled “Coming soon” per product preference.
...
Legend: `[x]` done · `[~]` partial · `[ ]` not started (same as [roadmap overview](/docs/roadmap)).
...
- [ ] Every Phase 2 tourist capability in [Phase 2 deliverables](/docs/roadmap/phase-2-marketplace-depth) has a named UI slot on an existing page
...
3. Read [frontend conventions](/docs/engineering/frontend-conventions) and [domain-to-code-mapping](/docs/engineering/domain-to-code-mapping) — update mapping when public discover routes land.
4. For behavior tied to Phase 2 APIs, scaffold placeholders only until the matching [implementation spec](/docs/specs/) is `approved`.
5. Verify pages against Phase 1 exit criteria in [Phase 1](/docs/roadmap/phase-1-mvp) before marking Milestone B complete.

---

## Related documents

- [Phase 1 — Web surfaces (minimum)](/docs/roadmap/phase-1-mvp#web-surfaces-minimum)
- [Phase 2 — red-cab-web deliverables](/docs/roadmap/phase-2-marketplace-depth)
- [FR-CAT-004 — Primary discovery navigation](/docs/requirements/functional-requirements/cat)
- [FR-IAM-012 — Guest browsing](/docs/requirements/functional-requirements/iam)
