...
function migrateFunctionalRequirements() {
  ...
  const sections = [
    ...
    { marker: '## Corporate —', slug: 'corporate', label: 'COR', title: 'Corporate — Quotation & Invoicing', pos: 7 },
...
function migrateRoadmap() {
  ...
  const phases = [
    ...
    },
    {
      ...
      prev: 'phase-1-mvp',
      prevLabel: 'Phase 1',
      next: 'phase-3-corporate-packages',
      nextLabel: 'Phase 3',
    },
    {
      marker: '## Phase 3 — Corporate + packages',
      slug: 'phase-3-corporate-packages',
      ...
      tldr: '- **Corporate + packages:** quotation request → formal PDF → bank transfer → Admin reconciliation.\n- Expands `corporate.dbml` beyond corporate profile; manifests and multi-day packages on Booking.\n- Corporate portal gates on `corporate_profiles` profile presence.',
    ...
    },
    {
      ...
      prev: 'phase-3-corporate-packages',
      prevLabel: 'Phase 3',
      next: null,
    },
  ];
